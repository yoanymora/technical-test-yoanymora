...
class Test(unittest.TestCase):
    ...
    def test_01_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(1), "The number 1 isn't prime.")

    def test_02_is_prime_number(self):
        """Case 2: 2 has 2 factors therefore is a prime number."""
        self.assertEqual(is_prime_number(2), "The number 2 is prime.")

    def test_03_is_prime_number(self):
        """Case 3: 3 has 2 factors therefore is a prime number."""
        self.assertEqual(is_prime_number(3), "The number 3 is prime.")
    ...
    def test_04_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(4), "The number 4 isn't prime.")

    def test_05_is_prime_number(self):
        """Case 5: 5 has 2 factors therefore is a prime number."""
        self.assertEqual(is_prime_number(5), "The number 5 is prime.")
    ...
    def test_06_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(6), "The number 6 isn't prime.")

    def test_07_is_prime_number(self):
        """Case 7: 7 has 2 factors therefore is a prime number."""
        self.assertEqual(is_prime_number(7), "The number 7 is prime.")
    ...
    def test_08_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(8), "The number 8 isn't prime.")
    ...
    def test_09_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(9), "The number 9 isn't prime.")

    def test_10_is_prime_number(self):
        """Case 10: 17 has 2 factors therefore is a prime number."""
        self.assertEqual(is_prime_number(17), "The number 17 is prime.")
    ...
    def test_16_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(674), "The number 674 isn't prime.")

    def test_17_is_prime_number(self):
        """Case 17: 997 has 2 factors therefore is a prime number."""
        self.assertEqual(is_prime_number(997), "The number 997 is prime.")
    ...
    def test_18_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(998), "The number 998 isn't prime.")
    ...
    def test_19_is_prime_number(self):
        ...
        self.assertEqual(is_prime_number(678), "The number 678 isn't prime.")
